...
var capResult, capLinks, capResultDataURL, capResultFileNameLite, multiPDFMode;
            ...
            function (request, sender, sendResponse) {
                ...
                switch (request.message) {
                    ...
                    case "loadScript":
                        ...
                        chrome.tabs.executeScript(currentTab.id, {file: "scripts/fsUtils.js", runAt: "document_start", frameId: frameId},
                            function () {
...
function getMenuSettings(callback)
{
    function runCallback(capturingNotSupported) {
        var unsupported = capturingNotSupported,
...
function capturePage(Action, Mode, Data, CallbackCompleted, tab, frameId)
{
    ...
    else
    {
        ...
        chrome.tabs.executeScript(tab.id, {file: "scripts/fsScriptChecker.js", runAt: "document_start", frameId: frameId}, function() {
...
function doCapturing(Action, Mode, Data, CallbackCompleted)
{
    ...
    try {
        var
            ...
            port.postMessage({topic: "init", mode: Mode, debug: isDebug, options: localStorage, p: localStorage[cPluginProModePref] == "true", native: isNativeSupported(), frameMode: currentFrameId > 0});
